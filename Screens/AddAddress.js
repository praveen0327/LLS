...
/*     setAssImg(require('../images/done.png'))
  ...
  const modalList=(item)=>{
    ...
    var subTotal = item.price*item.quantity
      ...
      return(
       <View style={{width:"100%",height:40,borderWidth:0.2,borderColor:"#000",backgroundColor:'#FFFFFF',marginTop:10,borderRadius:2,justifyContent:'space-around',alignContent:'center',flexDirection:'row'}}>
    ...
    <SafeAreaView
      ...
      <ScrollView>
        <View style={{marginTop:10,width:'100%',alignContent:'center',alignItems:'center'}}>
          ...
          <Text style={{fontSize:18,color:"#000"}}>CONTACT DETAILS</Text>
          </View>
              <View
                style={{
                  width:"100%",
      ...
      <TouchableOpacity
        ...
        {/* <ImageBackground
          ...
          <View
            ...
            <Text style={styles.outlined}>ADD ADDRESS</Text>
